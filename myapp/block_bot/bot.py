...
bot = Bot(token='5157344293:AAGUCPHN7Zhw6TDpWLhZfUVnS_96R_Xry_Q')
...
def bowlash(update, context):
    keyboard = [
        [KeyboardButton('Kimyo'), KeyboardButton('Bioloyiya')],
...
def begin(update, context):
    ...
    if course == 'Kimyo' or course == 'Tarix' or course == 'Ingliz tili' or course == 'Matematika' or course == 'Bioloyiya':
        keyboard = [
...
def test_begin(update, context):
    random_base = [i for i in Test.objects.all().values()]
